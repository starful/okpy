...
summary: リフト&シフトと段階移行、コスト・ダウンタイム・コンプライアンスの典型シナリオを面接用に要約。PM寄り/インフラ寄りの両方から飛んでくる論点を先に押さえる。
cover: https://storage.googleapis.com/ok-project-assets/okpy/career/cloud_migration_specialist.jpg
lang: ja
